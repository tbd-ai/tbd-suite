...
def train(create_tensor_dict_fn, create_model_fn, train_config, master, task,
          ...
          is_chief, train_dir, nvprof_on, nvprof_start_step, nvprof_stop_step):
...
# <EcoSys> specify args for customized train_step
    if nvprof_on:
        kwargs = {}
        kwargs['should_log'] = constant_op.constant(True)
        kwargs['nvprof_on'] = True
        kwargs['nvprof_start_step'] = nvprof_start_step
        kwargs['nvprof_stop_step'] = nvprof_stop_step
        step = train_step
    else:
        kwargs = 0
