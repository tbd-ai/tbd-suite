...
train_dataset = COCOInstance(root=coco_root, splits='instances_train2017', skip_empty=True)
# and val2014 (i.e. minival5k) test as validation data
val_dataset = COCOInstance(root=coco_root, splits='instances_val2017', skip_empty=False)
