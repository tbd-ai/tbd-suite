...
# <EcoSys> Added logs for training informations.
import logging
...
fh = logging.FileHandler('../source/tensorflow.log')
...
# <EcoSys> Added the GPU device instead of the CPU.
...
# <EcoSys> Added the tensorflow config session options.
