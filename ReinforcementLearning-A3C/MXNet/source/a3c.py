...
parser.add_argument('--log-dir', type=str, default="../source/log", help='directory of the log file')
...
# <EcoSys> Added profiling options.
parser.add_argument('--profile-start', type=int, default=50000)
parser.add_argument('--profile-stop', type=int, default=51000)
# </EcoSys>
