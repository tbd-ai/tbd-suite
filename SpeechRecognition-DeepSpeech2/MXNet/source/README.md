...
Uncomment following lines in make/config.mk and point WARPCTC_PATH to warp-ctc source
```
  WARPCTC_PATH = <path_to_DNN-Training-Suite>/SpeechRecognition-DeepSpeech2/MXNet/source/warp-ctc
  MXNET_PLUGINS += plugin/warpctc/warpctc.mk
```

Rebuild and reinstall MXNet. Follow build from source in this [link](https://mxnet.incubator.apache.org/install/index.html).
```
  make clean
