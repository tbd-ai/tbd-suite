...
# <EcoSys> Changed the measurement frequency from 50 to 100 updates.
MEASURE_SPEED_EVERY = 100  # measure speed and metrics every X batches
...
# <EcoSys> Changed the beam size from 5 to 10
