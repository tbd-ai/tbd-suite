...
from tensor2tensor.utils.profile_monitor import ProfileMonitor
from tensor2tensor.utils.time_monitor import TimeMonitor

import tensorflow as tf
from tensorflow.contrib.learn.python.learn import learn_runner
from tensorflow.python import debug

print("Dog ProfileMonitor")
...
def create_experiment(data_dir, model_name, train_steps, eval_steps, hparams,
  ...
  train_monitors.append(time_monitor)
