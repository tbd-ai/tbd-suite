...
def create_session_config(log_device_placement=False,
  ...
  #ybgao: hopefully will fix CUDNN failed to initialize 
...
def create_experiment(
  ...
  # ybgao: Add profiler hooks
  profiler_hook = tf.train.ProfilerHook(output_dir='/scratch', save_secs=60, show_memory=True)
